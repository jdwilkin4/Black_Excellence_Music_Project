...
const InstrumentalistPage = lazy(() =>
  import("../Performers/Instrumentalists")
);
const JazzComposersPage = lazy(() => import("../composers/JazzComposers"));
const ContemporaryClassicalComposers = lazy(() =>
  import("../composers/ClassicalContemporaryComposers")
);
...
const PerformersComposersRoutes = () => {
  return (
    <>
      <Route
        path="/contemporary-composers"
        exact
        component={ContemporaryClassicalComposers}
      />
