import { armstrongQuiz, coleridgeQuiz, fitzgeraldQuiz, gillespieQuiz } from './quiz-exports';
import { holidayQuiz, andersonQuiz, charlesQuiz, simoneQuiz } from './quiz-exports';
const quizCards = [
    {
