        ...
        <div>
            ...
            <div className="flex flex-row flex-wrap justify-center items-center my-2">
                {quizCards.map((artist, index) => (
                    <div key={index}>
                        <div className="mx-4 border-r border-l border-b-8 border-t-8 border-purple-700 rounded-lg p-8 flex flex-col justify-between leading-normal">
                            <div className=" text-center mb-2">
                                <h2 className="text-black font-bold text-xl mb-2">{artist.name}</h2>
