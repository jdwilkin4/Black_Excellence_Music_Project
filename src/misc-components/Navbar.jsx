  ...
  return (
    <>
      <nav className="relative flex flex-wrap items-center justify-between px-2 py-3 bg-purple-800 mb-3">
        <div className="md:container md:mx-auto px-4 mx-auto flex flex-wrap items-center justify-between">
          ...
          >
            <div className="flex flex-col lg:flex-row lg:ml-auto ">
              ...
              <Link className={navLinkStyles} to="/jazz-composers">
                {" "}
                Jazz Composers{" "}
              </Link>
              <Link className={navLinkStyles} to="/instrumentalists">
                Instrumentalists{" "}
              </Link>
              <Link className={navLinkStyles} to="/vocalists">
                {" "}
                Vocalists{" "}
              </Link>
              <Link className={navLinkStyles} to="/games">
                Games
              </Link>
            </div>
          </div>
