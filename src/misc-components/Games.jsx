...
const Games = () => {
  return (
    <>
      ...
      <GamesTemplate
        text={
          "Experience what is was like to be a young black jazz pianist in 1930's America."
        }
        path="/dayinlife"
    ...
    <div className="mx-auto px-4 py-8 max-w-xl my-10">
      <div className="bg-white shadow-2xl rounded-lg  tracking-wide">
        ...
        <div className="px-4 py-2">
          <h2 className="font-bold text-center text-2xl text-black-800 tracking-normal">
            {props.gameCategory}
          </h2>
        </div>
