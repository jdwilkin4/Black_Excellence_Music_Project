  ...
  return (
    <div className="flex  flex-wrap justify-center items-center my-2">
      {props.arr.map((composer, index) => (
        <div key={index}>
          <div
            className={`my-4 border-r-2 border-l-2 border-b-8 border-t-8 ${props.borderColor} rounded-lg`}
          >
            ...
            <div className="photo-wrapper p-2">
              <img
                ...
                src={process.env.PUBLIC_URL + composer.image}
                alt={composer.alt}
              />
            </div>
            <div className="text-center my-8">
              <a
                ...
                target="_blank"
                href={composer.bio}
                className={`w-1/2 px-4 py-3 text-white ${props.bgColor}  rounded-lg font-bold text-sm`}
              >
                Composer Bio
              </a>
            </div>
