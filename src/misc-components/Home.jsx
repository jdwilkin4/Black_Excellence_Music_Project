...
const Home = () => {
  ...
  const roundedImage =
    "inline-block h-60 w-60 rounded-full object-cover ring-2 ring-white";
      ...
      <div className="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
        ...
        <div className="flex-wrap w-full justify-center py-6 text-center flex -space-x-2">
          <img
            ...
            src={process.env.PUBLIC_URL + "/images/EllaFitzgerald923px.jpg"}
            alt="Ella Fitzgerald"
          />
          <img
            className={roundedImage}
            src={process.env.PUBLIC_URL + "/images/Terrance-Blanchard.jpg"}
            alt="Terrance Blanchard"
          />
          <img
            className={roundedImage}
            src={process.env.PUBLIC_URL + "/images/Margaret-Bonds-722.jpg"}
            alt="Margaret Bonds"
          />
          <img
            className={roundedImage}
            src={process.env.PUBLIC_URL + "/images/nathaniel-dett.jpg"}
            alt="Robert Nathaniel Dett"
          />
        </div>
      </div>
          ...
          <div className="lg:grid lg:grid-flow-row-dense lg:grid-cols-2 lg:gap-8 lg:items-center">
            <div className="lg:col-start-2 lg:max-w-2xl ml-auto">
              <p className="mt-4 text-2xl leading-6 text-center ">
                Learn about Michael Abels, Eleanor Alberga, William Levi Dawson,
                Tania Justina León, and more!
              </p>
              <div className="mt-8 md:grid md:grid-cols-2 gap-6">
                <ArtistSection
                  href="/contemporary-composers"
                  anchorText="Contemporary Composers"
                />
                <ArtistSection
                  href="/jazz-composers"
                  anchorText="Jazz Composers"
                />
                <ArtistSection
                  href="/instrumentalists"
                  anchorText="Instrumentalists"
                />
            ...
            <div className="mt-10 lg:-mx-4 relative relative-20 lg:mt-0 lg:col-start-1">
              <div className="relative space-y-4">
                <div className="flex items-end justify-center lg:justify-start space-x-4">
                  <img
                    className="rounded-lg  w-32 md:w-56"
                    src={process.env.PUBLIC_URL + "/images/piano1.jpg"}
                    alt="Piano"
                  />
                  <img
                    className="rounded-lg  w-40 md:w-64"
                    src={process.env.PUBLIC_URL + "/images/jazzsax1.jpg"}
                    alt="Unknown jazz saxophonist"
                  />
                </div>
                <div className="flex items-start justify-center lg:justify-start space-x-4 ml-12">
                  <img
                    className="rounded-lg  w-24 md:w-40"
                    src={process.env.PUBLIC_URL + "/images/drummer1.jpg"}
                    alt="Unknown Drummer"
                  />
                  <img
                    className="rounded-lg  w-32 md:w-56"
                    src={process.env.PUBLIC_URL + "/images/vocalist1.jpg"}
                    alt="Vocal silhouette"
                  />
                </div>
              </div>
            </div>
      ...
      <div className="min-w-screen min-h-screen mt-10 px-5 py-5">
        ...
        <div className="flex flex-row flex-wrap justify-center items-center my-2">
          {quizCardArr.map((artist, index) => (
            <div
              key={index}
              className="mx-4 mb-4 border-r border-l border-b-8 border-t-8 border-purple-700 rounded-lg p-8  justify-between leading-normal"
            >
              ...
              <div className="text-center mt-4 mb-8">
                <a
                  ...
                  target="_blank"
                  href={artist.bio}
                  className="w-1/2 px-4 py-3 text-white bg-purple-700  rounded-lg font-bold text-sm"
                >
                  {artist.name} Bio
                </a>
              </div>
              <div className="text-center">
                <Link
                  to={artist.quiz}
                  className="w-1/2 px-4 py-3 text-white bg-green-700  rounded-lg font-bold text-sm"
                >
                  Take quiz
                </Link>
              </div>
      ...
      <div className="container flex flex-col px-6 py-4 mx-auto space-y-6 md:h-128 md:py-16 md:flex-row md:items-center md:space-x-6">
        <div className="flex flex-col items-center w-full md:flex-row md:w-1/2">
          <div className="max-w-lg md:mx-12 md:order-2">
            ...
            <p className="text-xl text-center mt-12">
              Explore what it is like to be a 1930's jazz pianist.
            </p>
            <p className="text-xl text-center mt-4 mb-12">
              Tour the U.S. and perform in all the top jazz clubs.
            </p>
            <div className="my-6 text-center">
              <Link className={linkStyles} to="/dayinlife">
        ...
        <div className="flex items-center justify-center w-full h-96 md:w-1/2">
          <img
            ...
            src={process.env.PUBLIC_URL + "/images/NYC-overview (1).jpg"}
            alt="New York City"
          />
        </div>
      </div>
    ...
    <>
      <div className="mt-6 lg:mt-0">
        <div className="text-center flex justify-center mt-12">
          <Link
            className="w-1/2 px-4 py-6 text-white bg-green-700 rounded-lg "
            to={props.href}
          >
            {props.anchorText}
          </Link>
